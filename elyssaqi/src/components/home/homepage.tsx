...
const Homepage: React.FC = () => {
  ...
  // Calculate the maximum scroll distance for the text container
  const maxScrollDistance = window.innerHeight; // Adjust this value if needed
  const textContainerOffset = Math.min(scrollY, maxScrollDistance);
    ...
    <>
      <div className="homepage-container">
        ...
        <div className="text-container"
          style={{ transform: `translate(-50%, calc(-50% - ${textContainerOffset}px))` }} // Moves up on scroll
        >
